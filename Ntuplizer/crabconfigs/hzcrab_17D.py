...
config.General.requestName = 'HZgamma94XSinglePhoton_%s_2017D'%"May17"
config.General.workArea = 'crab_jobs_2017D_photon%s'%"May17"
...
config.Data.outputDatasetTag = 'HZgamma94XSinglePhoton_%s_2017D'%"May17"
