...
config.General.requestName = 'HZgamma94XSinglePhoton_%s_2017B'%"May17"
config.General.workArea = 'crab_jobs_2017B_photon%s'%"May17"
...
config.Data.outputDatasetTag = 'HZgamma94XSinglePhoton_%s_2017B'%"May17"
