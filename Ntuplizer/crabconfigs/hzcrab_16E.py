...
config.General.requestName = 'HZgamma102XSinglePhoton_%s_2016E'%"Jul9"
config.General.workArea = 'crab_jobs_2016E_photon%s'%"Jul9"
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'cfg_Data2016E.py'
...
config.Data.outputDatasetTag = 'HZgamma102XSinglePhoton_%s_2016E'%"Jul9"
