...
config.General.requestName = 'Wgamma94XSingleMuon_%s_2017E'%"Jan10"
config.General.workArea = 'crab_jobs_2017E_muon%s'%"Jan10"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuon_%s_2017E'%"Jan10"
