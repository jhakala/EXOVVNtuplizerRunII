...
config.General.requestName = 'Wgamma94XSingleMuon_%s_2017E'%"Jun17"
config.General.workArea = 'crab_jobs_2017E_muon%s'%"Jun17"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuon_%s_2017E'%"Jun17"
