...
config.General.requestName = 'Wgamma94XSingleMuon_%s_2017D'%"Jun17"
config.General.workArea = 'crab_jobs_2017D_muon%s'%"Jun17"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuon_%s_2017D'%"Jun17"
