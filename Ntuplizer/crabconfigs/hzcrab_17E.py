...
config.General.requestName = 'HZgamma94XSinglePhoton_%s_2017E'%"May17"
config.General.workArea = 'crab_jobs_2017E_photon%s'%"May17"
...
config.Data.outputDatasetTag = 'HZgamma94XSinglePhoton_%s_2017E'%"May17"
