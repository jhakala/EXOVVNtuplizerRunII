...
config.General.requestName = 'HZgamma94XSinglePhoton_%s_2017E'%"Apr12"
config.General.workArea = 'crab_jobs_2017E_photon%s'%"Apr12"
...
config.Data.outputDatasetTag = 'HZgamma94XSinglePhoton_%s_2017E'%"Apr12"
