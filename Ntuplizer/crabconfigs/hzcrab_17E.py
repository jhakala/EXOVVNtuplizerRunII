...
config.General.requestName = 'HZgamma94XSinglePhoton_%s_2017E'%"Apr20"
config.General.workArea = 'crab_jobs_2017E_photon%s'%"Apr20"
...
config.Data.outputDatasetTag = 'HZgamma94XSinglePhoton_%s_2017E'%"Apr20"
