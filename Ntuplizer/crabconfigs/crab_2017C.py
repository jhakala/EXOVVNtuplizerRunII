...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2017C'%"Jul06"
config.General.workArea = 'crab_jobs_2017C_photon%s'%"Jul06"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2017C'%"Jul06"
