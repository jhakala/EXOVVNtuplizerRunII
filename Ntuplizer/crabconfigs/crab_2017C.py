...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2017C'%"Aug02"
config.General.workArea = 'crab_jobs_2017C_photon%s'%"Aug02"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2017C'%"Aug02"
