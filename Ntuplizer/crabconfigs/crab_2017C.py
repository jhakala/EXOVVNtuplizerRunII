...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2017C'%"Jun25"
config.General.workArea = 'crab_jobs_2017C_photon%s'%"Jun25"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2017C'%"Jun25"
