...
config.General.requestName = 'Wgamma94XSingleMuon_%s_2017C'%"Jun17"
config.General.workArea = 'crab_jobs_2017C_muon%s'%"Jun17"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuon_%s_2017C'%"Jun17"
