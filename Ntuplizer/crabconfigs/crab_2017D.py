...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2017D'%"Jul06"
config.General.workArea = 'crab_jobs_2017D_photon%s'%"Jul06"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2017D'%"Jul06"
