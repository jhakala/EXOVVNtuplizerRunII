...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2017D'%"Jan10"
config.General.workArea = 'crab_jobs_2017D_photon%s'%"Jan10"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2017D'%"Jan10"
