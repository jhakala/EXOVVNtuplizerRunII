...
config.General.requestName = 'HZgamma94XSinglePhoton_%s_2017F'%"Apr20"
config.General.workArea = 'crab_jobs_2017F_photon%s'%"Apr20"
...
config.Data.outputDatasetTag = 'HZgamma94XSinglePhoton_%s_2017F'%"Apr20"
