...
config.General.requestName = 'Wgamma94XSingleMuon_%s_2017B'%"Jun17"
config.General.workArea = 'crab_jobs_2017B_muon%s'%"Jun17"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuon_%s_2017B'%"Jun17"
