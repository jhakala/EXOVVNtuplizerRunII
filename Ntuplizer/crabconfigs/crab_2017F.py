...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2017F'%"Aug14"
config.General.workArea = 'crab_jobs_2017F_photon%s'%"Aug14"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2017F'%"Aug14"
