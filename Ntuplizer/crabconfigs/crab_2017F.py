...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2017F'%"Aug07"
config.General.workArea = 'crab_jobs_2017F_photon%s'%"Aug07"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2017F'%"Aug07"
