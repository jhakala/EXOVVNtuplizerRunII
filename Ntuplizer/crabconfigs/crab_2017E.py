...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2017E'%"Aug13"
config.General.workArea = 'crab_jobs_2017E_photon%s'%"Aug13"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2017E'%"Aug13"
