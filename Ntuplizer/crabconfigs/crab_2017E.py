...
config.General.requestName = 'Wgamma94XSinglePhoton_%s_2017E'%"Jul06"
config.General.workArea = 'crab_jobs_2017E_photon%s'%"Jul06"
...
config.Data.outputDatasetTag = 'Wgamma94XSinglePhoton_%s_2017E'%"Jul06"
