...
from VgammaTuplizer.Ntuplizer.ntuplizerOptions_mc2018_cfi import config
...
dirList = check_output(split("xrdfs root://cmseos.fnal.gov ls /store/group/lpcboostres/ZGamma-2018_M%i_W0.00014_v2"%options.mass))
miniAODs = []
...
GT = ''
if config["RUNONMC"]: GT = '102X_upgrade2018_realistic_v21'
